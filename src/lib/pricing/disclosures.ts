...
export const RPARRY_DISCLOSURES: string[] = [
  ...
  "R Parry Financial, LLC — licensed Mortgage Loan Originator, NMLS ID #1924318. Richard P. McHargue — NMLS ID #927662. Equal Housing Lender. Loan programs are subject to change without notice; all loans are subject to credit approval.",
];
