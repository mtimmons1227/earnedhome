...
export type Database = {
  public: {
    Tables: {
      ...
      communities: {
        Row: { id: string; tenant_id: string; name: string; location: string | null; active: boolean; created_at: string };
        Insert: { id?: string; tenant_id: string; name: string; location?: string | null; active?: boolean; created_at?: string };
        Update: Partial<Database["public"]["Tables"]["communities"]["Insert"]>;
        Relationships: [];
      };
      app_users: {
        Row: { id: string; tenant_id: string; role: Database["public"]["Enums"]["user_role"]; full_name: string | null; email: string | null; nmls: string | null; created_at: string };
        Insert: { id: string; tenant_id: string; role?: Database["public"]["Enums"]["user_role"]; full_name?: string | null; email?: string | null; nmls?: string | null; created_at?: string };
      ...
      leads: {
        Row: { id: string; tenant_id: string; community_id: string | null; quote_id: string | null; agent_id: string | null; full_name: string | null; email: string | null; phone: string | null; consent_tcpa: boolean; consent_text: string | null; consent_at: string | null; source: string | null; routed_to: string | null; status: Database["public"]["Enums"]["lead_status"]; created_at: string };
      ...
      agents: {
        Row: { id: string; tenant_id: string; name: string; email: string | null; phone: string | null; slug: string; active: boolean; created_at: string; updated_at: string };
        Insert: { id?: string; tenant_id: string; name: string; email?: string | null; phone?: string | null; slug: string; active?: boolean; created_at?: string; updated_at?: string };
