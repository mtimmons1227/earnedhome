...
export type Database = {
  public: {
    Tables: {
      ...
      leads: {
        Row: { id: string; tenant_id: string; community_id: string | null; quote_id: string | null; full_name: string | null; email: string | null; phone: string | null; consent_tcpa: boolean; consent_text: string | null; consent_at: string | null; source: string | null; routed_to: string | null; status: Database["public"]["Enums"]["lead_status"]; created_at: string };
