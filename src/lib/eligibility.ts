...
export function evaluateEligibility(input: PricingInput): Eligibility {
  ...
  if (!conventional.eligible && !fha.eligible && !va.eligible) {
    if (loan > LIMITS.jumboTier2Max)
      routeMessage = "This loan is above our standard limits — let's talk through your options. Use “Connect with my mortgage advisor” below.";
    else
      routeMessage = "Let's talk through your options to find the right program for you. Use “Connect with my mortgage advisor” below.";
  }
